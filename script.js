const translations = {
  en: {
    ...
    case1Result: 'CSV · XLS · XLSX<br>59-field data model<br>238 matching cases · 25 merge tests', privateNote: 'Verified from a private repository; clients, business volumes, and identifying details are omitted.',
  ...
  pl: {
    ...
    case1Result: 'CSV · XLS · XLSX<br>59-polowy model danych<br>238 przypadków dopasowania · 25 testów scalania', privateNote: 'Zweryfikowano w prywatnym repozytorium; pominięto klientów, wolumeny biznesowe i dane identyfikujące.',
