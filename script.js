const translations = {
  en: {
    ...
    modernizationKicker: 'Production system · Anonymized', modernizationTitle: 'Production legacy platform modernization',
    modernizationText: 'Modernized and operated a production PHP platform spanning 2,100+ tracked files and 880+ PHP files. Reduced the tracked repository footprint by 36.3% while introducing regression testing, Dockerized Python integration services, database migrations, and automated deployments to two environments.',
    measuredEvidence: 'Measured evidence', modernizationResult: '396 tests · 1,108 assertions<br>0 failures in a clean run<br>36.3% fewer tracked files',
    modernizationNote: 'Verified from repository history and a clean July 2026 test run; one credential-dependent integration test was skipped.',
  ...
  pl: {
    ...
    modernizationKicker: 'System produkcyjny · Anonimowo', modernizationTitle: 'Modernizacja produkcyjnej platformy legacy',
    modernizationText: 'Modernizowałem i utrzymywałem produkcyjną platformę legacy w PHP, obejmującą ponad 2100 śledzonych plików, w tym ponad 880 plików PHP. Zmniejszyłem liczbę śledzonych plików o 36,3%, jednocześnie wprowadzając testy regresji, konteneryzowane usługi integracyjne w Pythonie, migracje bazy danych i automatyczne wdrożenia do dwóch środowisk.',
    measuredEvidence: 'Zmierzony rezultat', modernizationResult: '396 testów · 1 108 asercji<br>0 błędów w czystym uruchomieniu<br>36,3% mniej śledzonych plików',
    modernizationNote: 'Metryki zweryfikowano na podstawie historii repozytorium i czystego uruchomienia testów w lipcu 2026; pominięto jeden test integracyjny wymagający poświadczeń.',
