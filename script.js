const translations = {
  en: {
    ...
    case4Kicker: 'Loyalty-card platform · Public source', case4Title: 'Rebuilding a loyalty-card system for more businesses',
    case4Text: '<span class="comparison-part"><strong>Before:</strong> the first version served one business. Customer registration, physical-card inventory, branding, and external integrations shared one setup, so adding another business would have required custom code and could have mixed settings or data.</span><span class="comparison-part"><strong>After:</strong> I rebuilt it as a Django platform that keeps every business separate. A customer scans a physical card; the system assigns it, records consent, synchronizes the customer with Dotykačka, prepares a personal Apple Wallet or Google Wallet card, updates Brevo, and sends the card by email. Each business has separate branding, inventory, users, and encrypted integration credentials. If an external service fails temporarily, background jobs can retry safely.</span>',
    case4Result: '267 customer records preserved<br>Complete 600-card inventory preserved<br>228 automated tests · SQLite + MariaDB', case4Note: 'The technical conversion is complete. Adding more businesses remains disabled until final human, provider, and printing checks. Public source is available; customer data, credentials, and generated Wallet cards stay private.', viewPublicSource: 'View public source',
  ...
  pl: {
    ...
    case4Kicker: 'Platforma kart lojalnościowych · Publiczny kod', case4Title: 'Przebudowa systemu kart lojalnościowych dla kolejnych firm',
    case4Text: '<span class="comparison-part"><strong>Przed:</strong> pierwsza wersja obsługiwała jedną firmę. Rejestracja klientów, pula kart fizycznych, wygląd kart i integracje korzystały z jednej konfiguracji, dlatego dodanie kolejnej firmy wymagałoby zmian w kodzie i groziłoby pomieszaniem ustawień lub danych.</span><span class="comparison-part"><strong>Po:</strong> przebudowałem system w platformę Django, która oddziela dane każdej firmy. Klient skanuje kartę fizyczną, a system przypisuje ją, zapisuje zgodę, synchronizuje klienta z Dotykačka, przygotowuje osobistą kartę Apple Wallet lub Google Wallet, aktualizuje kontakt w Brevo i wysyła kartę e-mailem. Każda firma ma osobny wygląd, pulę kart, użytkowników i zaszyfrowane dane dostępowe do integracji. Gdy usługa zewnętrzna chwilowo nie działa, zadanie może zostać bezpiecznie ponowione.</span>',
    case4Result: 'Zachowano 267 rekordów klientów<br>Zachowano pełną pulę 600 kart fizycznych<br>228 testów automatycznych · SQLite + MariaDB', case4Note: 'Przebudowa techniczna jest ukończona. Dodawanie kolejnych firm pozostaje wyłączone do czasu końcowego odbioru oraz testów integracji i druku. Kod źródłowy jest publiczny; dane klientów, dane dostępowe i wygenerowane karty Wallet pozostają prywatne.', viewPublicSource: 'Zobacz publiczny kod',
