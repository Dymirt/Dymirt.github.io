const translations = {
  ...
  pl: {
    ...
    case4Text: '<strong>Przed:</strong> dane klientów i programu lojalnościowego pozostawały w systemie sprzedażowym Dotykačka, bez spersonalizowanej karty w telefonie klienta. <strong>Po:</strong> połączyłem Dotykačka z aplikacją Django, która tworzy osobistą kartę lojalnościową kawiarni do Apple Wallet lub Google Wallet i daje obsłudze jedno miejsce do zarządzania programem.',
